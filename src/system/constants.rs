...
// pub const SPEED_OF_LIGHT: Velocity = MetrePerSecond::new(299_792_458.0);
...
use crate::system::Acceleration;

// // Standard acceleration of gravity g₀
pub const STANDARD_GRAVITY: Acceleration = MetrePerSecondSquared::new_const(9.806_65);
